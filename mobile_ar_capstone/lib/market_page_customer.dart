...
class _MarketPageCustomerPageState extends State<MarketPageCustomer> {
  ...
  List<Livestock> _applyFilters() {
    return _livestockList.where((livestock) {
      bool matchesType = _filterType == 'All' || livestock.type == _filterType;
      bool matchesSex = _filterSex == 'All' || livestock.sex == _filterSex;
      bool matchesAge = livestock.age >= _filterAgeMin && livestock.age <= _filterAgeMax;
